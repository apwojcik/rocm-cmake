...
function(_rocm_check_toolchain_var var access value list_file)
...
macro(rocm_disable_variable_watching)
    function(rocm_check_toolchain_var)
    endfunction()
endmacro()

macro(rocm_enable_variable_watching)
    function(rocm_check_toolchain_var)
        _rocm_check_toolchain_var($ARGN)
    endfunction()
endmacro()

rocm_enable_variable_watching()
